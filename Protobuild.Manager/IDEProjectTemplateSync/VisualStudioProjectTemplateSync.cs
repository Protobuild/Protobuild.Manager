            ...
            foreach (var version in vsVersions)
            {
                ...
                foreach (var template in _templateSource.GetTemplates())
                {
                    var xml =
                        ...
                        "  <TemplateContent>" +
                        "    <CustomParameters>" +
                        "      <CustomParameter Name=\"ProtobuildManagerExecutablePath\" Value=\"" + SecurityElement.Escape(assemblyPath) + "\" />" +
                        "      <CustomParameter Name=\"ProtobuildManagerWorkingDirectory\" Value=\"" + SecurityElement.Escape(workingDirectory) + "\" />" +
                        "      <CustomParameter Name=\"ProtobuildManagerTemplateURL\" Value=\"" + SecurityElement.Escape(template.TemplateURI) + "\" />" +
                        "    </CustomParameters>" +
                        "  </TemplateContent>" +
                        "  <WizardExtension>" +
